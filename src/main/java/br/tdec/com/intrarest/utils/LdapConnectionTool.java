package br.tdec.com.intrarest.utils;
...
public class LdapConnectionTool {
	...
	private static final String QUERY = "CN=Marcelo Castro, O=TDec";;
	private static String query;

	public LdapConnectionTool(String query) throws NamingException {
		LdapConnectionTool.query = query;
		execute();
	}
	...
	private static Hashtable<String, String> createEnvironmentFromProperties() {
		...
		String url = System.getProperty("ldap://mcastro.tdec.com.br:389");
		String user = System.getProperty("mcastro");
		String password = System.getProperty("Hodge$404");
		String query = System.getProperty(QUERY, user);
		System.out.println("Query eh " + query);
